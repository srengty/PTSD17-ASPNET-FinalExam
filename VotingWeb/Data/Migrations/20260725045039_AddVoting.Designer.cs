...
namespace VotingWeb.Migrations
{
    ...
    [Migration("20260725045039_AddVoting")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VotingWeb.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("VotingWeb.Models.UserVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VotingWeb.Models.VotingTopic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VotingWeb.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VotingWeb.Models.UserVote", b =>
                {
                    b.HasOne("VotingWeb.Models.VotingTopic", "Topic")
                        .WithMany("UserVotes")
                        .HasForeignKey("TopicId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VotingWeb.Data.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
